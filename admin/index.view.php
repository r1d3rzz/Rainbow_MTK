...
require '../boostrap.php';
  $customer = mysqli_query($con,"SELECT * FROM register");
  $product = mysqli_query($con,"SELECT * FROM items");
  $order = mysqli_query($con,"SELECT * FROM orders");
  $message = mysqli_query($con,"SELECT * FROM contact");

  $customerVal = mysqli_num_rows($customer);
  $productVal = mysqli_num_rows($product);
  $orderVal = mysqli_num_rows($order);
  $messageVal = mysqli_num_rows($message);
