...
<body>
            ...
            <li class="selected first-slide">
                <div class="cd-full-width">
                    <div class="tm-slide-content-div slide-caption">
                        ...
                        <h2 style="color: #fafafa;">BrandLook</h2>
                ...
                <div class="projects-holder-3">
                    <div class="filter-categories">
                        <ul class="project-filter">
                            ...
                            <li class="filter" data-filter="nature"><span>Man</span></li>
                            <li class="filter" data-filter="workspace"><span>Footwear</span></li>
                            <li class="filter" data-filter="city"><span>accessories</span></li>
                            <li class="filter" data-filter="technology"><span>Bag</span></li>
                        </ul>
                    </div>
    ...
    if(isset($_POST['send']))
    {
        ...
        $sql = mysqli_query($con,"INSERT INTO contact VALUES('','$email','$name','$message')");
                ...
                <div class="col-md-6">
                    <div class="row">
                      <form id="contact" action="" method="post">
                        ...
                        <div class="col-md-12">
                          <fieldset>
                            <button type="submit" id="form-submit" name="send" class="btn">Send Message</button>
                          </fieldset>
                        </div>
                      </form>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="copyright-text">
                        <p>Copyright &copy; 2020 Rider Company Limited
                        
                        - Design: <a href="#" target="_parent">Rider</a></p>
                    </div>
                </div>
                <div class="col-md-6">
