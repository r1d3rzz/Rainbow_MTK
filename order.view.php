...
session_start();
	...
	$sql = mysqli_query($con,"SELECT * FROM items WHERE img = '$imgName'");
	...
	if($_POST['order'])
	{
		...
		$query = mysqli_query($con,"INSERT INTO orders VALUES ('$orderId','$product','$price','$name','$mobile','$city','$address')");
